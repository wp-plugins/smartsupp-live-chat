...
Requires: Wordpress 3.6.0 or higher

    Install Smartsupp plugin in Wordpress and activate it
    Insert your Smartsupp key in plugin settings (you received the key on your email when you created a Smartsupp account. If you don’t have a Smartsupp account yet, create one at www.smartsupp.com)
    Enable visitor identification in plugin settings (optional)
    Now Smartsupp chat is visible on your website. Sign in to Smartsupp and start chatting with your visitors.
